...
TEST_CASE("Because SCCGraphs are Graphs, a SCCGraph is traversable") {
    SCCGraph sIO("./tests/mock-data/scc-names.csv", "./tests/mock-data/scc-edges.txt");
    Vertex v0(0,"Hequfegoho a");
    BFSTraversal bfs = sIO.getBFS(20);
    int count{};
